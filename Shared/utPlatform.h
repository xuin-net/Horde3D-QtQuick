...
#define H3D_RENDERER_GL		1
#define H3D_RENDERER_GLES2	2
#define H3D_RENDERER_D3D11	3

#ifdef FORCE_H3D_RENDERER_GLES2
#define	H3D_RENDERER H3D_RENDERER_GLES2
#elif defined(FORCE_H3D_RENDERER_GL)
#define	H3D_RENDERER H3D_RENDERER_GL
#elif defined(FORCE_H3D_RENDERER_D3D11)
#define	H3D_RENDERER H3D_RENDERER_D3D11
#endif
