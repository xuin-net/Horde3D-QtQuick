    ...
    Column{
        ...
        Row{
            ...
            Slider {
                value: 0.5;
                onPressedChanged: {
                    model_4.rotationX = (value-0.5)*180;
                }
            }
        }
        Row{
            ...
            Slider {
                value: 0.5;
                onPressedChanged: {
                    model_4.rotationY = (value-0.5)*720;
                }
            }
        }
        Row{
            ...
            Slider {
                value: 0.5;
                onPressedChanged: {
                    model_4.rotationZ = (value-0.5)*180;
                }
            }
        }
        Row{
